...
void Date::read_Date(){
  ...
  if( a > 12 )
    ap::error("invalid month: ", a);

  if( has_30_days(Months(a) ) && day > 30 )
    ap::error("invalid date: ", *this);
  if( month == feb && day > 29 )
    ap::error("invalid date: ", *this);
  ...
  if( month == feb && !is_leap( year ) && day > 28 ){
    ap::error("invalid date: ", *this, "cannot exist");
  }
